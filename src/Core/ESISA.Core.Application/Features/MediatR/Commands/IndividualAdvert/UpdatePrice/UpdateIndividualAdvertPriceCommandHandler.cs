...
{
    public class UpdateIndividualAdvertPriceCommandHandler : IRequestHandler<UpdateIndividualAdvertPriceCommandRequest, UpdateIndividualAdvertPriceCommandResponse>
    {
        ...
        public UpdateIndividualAdvertPriceCommandHandler(IAdvertQueryRepository advertQueryRepository, IIndividualAdvertCommandRepository individualAdvertCommandRepository, IIndividualAdvertQueryRepository individualAdvertQueryRepository, IndividualAdvertBusinessRules individualAdvertBusinessRules)
        {
        ...
        public async Task<UpdateIndividualAdvertPriceCommandResponse> Handle(UpdateIndividualAdvertPriceCommandRequest request, CancellationToken cancellationToken)
        {
            ...
            individualAdvert.Price = request.UpdatedPrice;
            ...
            return new UpdateIndividualAdvertPriceCommandResponse(new SuccessfulContentResponse<IndividualAdvertDto>(individualAdvertDto, ResponseTitles.Success, ResponseMessages.PriceUpdated, System.Net.HttpStatusCode.OK));
        }
    }

...
namespace ESISA.Core.Application.Features.MediatR.Commands.Votes.ToAdvert.CreateCorporateAdvertUpVote
{
    public class CreateIndividualCustomerCorporateAdvertUpVoteCommandHandler : IRequestHandler<CreateIndividualCustomerCorporateAdvertUpVoteCommandRequest, CreateIndividualCustomerCorporateAdvertUpVoteCommandResponse>
    {
        ...
        public async Task<CreateIndividualCustomerCorporateAdvertUpVoteCommandResponse> Handle(CreateIndividualCustomerCorporateAdvertUpVoteCommandRequest request, CancellationToken cancellationToken)
        {
            ...
            return await Task.FromResult(new CreateIndividualCustomerCorporateAdvertUpVoteCommandResponse(new SuccessfulContentResponse<IndividualCustomerCorporateAdvertVoteDto>(individualCustomerCorporateAdvertDto,

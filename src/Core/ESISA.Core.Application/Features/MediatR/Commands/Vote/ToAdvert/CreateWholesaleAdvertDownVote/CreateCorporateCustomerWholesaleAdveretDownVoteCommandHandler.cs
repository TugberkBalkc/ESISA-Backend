...
{
    public class CreateCorporateCustomerWholesaleAdveretDownVoteCommandHandler : IRequestHandler<CreateCorporateCustomerWholesaleAdveretDownVoteCommandRequest, CreateCorporateCustomerWholesaleAdveretDownVoteCommandResponse>
    {
        ...
        public async Task<CreateCorporateCustomerWholesaleAdveretDownVoteCommandResponse> Handle(CreateCorporateCustomerWholesaleAdveretDownVoteCommandRequest request, CancellationToken cancellationToken)
        {
            ...
            return await Task.FromResult(new CreateCorporateCustomerWholesaleAdveretDownVoteCommandResponse(new SuccessfulContentResponse<CorporateCustomerWholesaleAdvertVoteDto>(corporateCustomerWholesaleAdvertVoteDto,

...
{
    public class CreateIndividualCustomerIndividualDealerDownVoteCommandHandler : IRequestHandler<CreateIndividualCustomerIndividualDealerDownVoteCommandRequest, CreateIndividualCustomerIndividualDealerDownVoteCommandResponse>
    {
        ...
        public async Task<CreateIndividualCustomerIndividualDealerDownVoteCommandResponse> Handle(CreateIndividualCustomerIndividualDealerDownVoteCommandRequest request, CancellationToken cancellationToken)
        {
            ...
            return await Task.FromResult(new CreateIndividualCustomerIndividualDealerDownVoteCommandResponse(new SuccessfulContentResponse<IndividualCustomerIndividualDealerVoteDto>(individualCustomerIndividualDealerVoteDto,
                                                                                   ResponseTitles.Success,
                                                                                   ResponseMessages.DealerDownVoted,
